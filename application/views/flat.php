...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <div class="tagsinput-primary">
                <input name="tagsinput" class="tagsinput" data-role="tagsinput" data-bind="value:message"  value="School, Teacher, Colleague" />
            </div>
        </div> <!-- /.col-xs-6 -->
    </div> <!-- /.row -->
    ...
    <div class="demo-row typography-row">
        ...
        <div class="demo-content">
            <div class="demo-type-example">
                <h1><span class="demo-heading-note">Header 1</span>洗澡横穿了W</h1>
            </div>
            <div class="demo-type-example">
            ...
            <div class="demo-type-example">
                ...
                <img src="<?=base_url()?>static/flatUI/docs/assets/img/example-image.jpg" alt="example-image" class="img-rounded img-responsive">
    ...
    <div class="demo-illustrations">
        <div class="demo-content">
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/pencils.svg" alt="Pensils"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/retina.svg" alt="Retina"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/compas.svg" alt="Compas"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/map.svg" alt="Map"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/chat.svg" alt="Chat"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/mail.svg" alt="Mail"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/book.svg" alt="Book"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/calendar.svg" alt="Calendar"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/clocks.svg" alt="Watches"></div>
            <div><img src="<?=base_url()?>static/flatUI/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
    </div>
    ...
    <div class="row demo-samples">
        ...
        <div class="col-xs-8">
            <video class="video-js" preload="auto" poster="<?=base_url()?>static/flatUI/docs/assets/img/video/poster.jpg" data-setup="{}">
<!--                <source src="http://iurevych.github.com/Flat-UI-videos/big_buck_bunny.mp4" type="video/mp4">-->
<!--                <source src="http://iurevych.github.com/Flat-UI-videos/big_buck_bunny.webm" type="video/webm">-->

                <source src="<?=base_url()?>static/video/maka.mp4" type="video/mp4">
<!--                <source src="http://iurevych.github.com/Flat-UI-videos/big_buck_bunny.webm" type="video/webm">-->
    ...
    <div class="row demo-tiles">
        ...
        <div class="col-xs-3">
            <div class="tile">
                <img src="<?=base_url()?>/static/flatUI/img/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
            <div class="tile">
                <img src="<?=base_url()?>/static/flatUI/img/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
            <div class="tile tile-hot">
                <img src="<?=base_url()?>/static/flatUI/img/icons/svg/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
                <img src="<?=base_url()?>/static/flatUI/img/icons/svg/chat.svg" alt="Chat" class="tile-image">
    ...
    <div class="row">
        <div class="col-xs-9">
            <div class="demo-browser">
                ...
                <div class="demo-browser-content">
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-1.jpg" alt="" />
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-2.jpg" alt="" />
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-3.jpg" alt="" />
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-4.jpg" alt="" />
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-5.jpg" alt="" />
                    <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/browser-pic-6.jpg" alt="" />
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-3">
            <div class="demo-download">
                <img src="<?=base_url()?>/static/flatUI/docs/assets/img/demo/html-icon.png" src="Free PSD" />
            </div>
        ...
        <div class="row">
            <div class="col-xs-7">
                ...
                <a class="footer-brand" href="http://designmodo.com" target="_blank">
                    <img src="<?=base_url()?>static/flatUI/docs/assets/img/footer/logo.png" alt="Designmodo.com" />
                </a>
            </div> <!-- /col-xs-7 -->
...
<script src="<?=base_url()?>/static/flatUI/dist/js/vendor/jquery.min.js"></script>
<script src="<?=base_url()?>/static/flatUI/dist/js/vendor/video.js"></script>
<script src="<?=base_url()?>/static/flatUI/dist/js/flat-ui.min.js"></script>
<script src="<?=base_url()?>/static/flatUI/docs/assets/js/application.js"></script>

<script>
    videojs.options.flash.swf = "<?=base_url()?>/static/flatUI/dist/js/vendors/video-js.swf"
</script>

<script>

    flat_VM = {
        message : ko.observable('你好,我好,大家好')
    }

    ko.applyBindings(flat_VM);
